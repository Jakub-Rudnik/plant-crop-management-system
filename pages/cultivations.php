...
<div class="site__header">
    <h1>Uprawy</h1>
    <button class="btn" title="Dodaj uprawę" onclick="createModal(addCropModal, 'crop-add')">
...
<div class="card__wrapper">
    ...
    foreach ($crops as $crop) {
       ...
       $editBtn = '<a class="btn btn__accent" onclick="createModal(editCropModal, \'crop-edit' . '\', ' . $cropId . ')">Edytuj</a>';
